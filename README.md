...
<head>
    ...
    <title>Tamilarasan| Portfolio</title>
    <style>
        body {
...
<body>
    ...
    <div class="container">
        <div class="content">
            <h2>About Me</h2>
            <p>I am Tamilarasan, a passionate college student eager to learn and explore web designing and development.</p>
        </div>
        <div class="content">
            <h2>Skills</h2>
            <ul>
        ...
        <div class="content">
            <h2>Contact</h2>
            <p>Email: tamilarasan6229@gmail.com</p>
            <p>/</a></p>
        </div>
    </div>
    <div class="footer">
        <p>&copy; 2025 Tamilarasan | All Rights Reserved</p>
    </div>
</body>
</html>
